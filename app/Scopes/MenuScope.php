...
class MenuScope implements \Illuminate\Database\Eloquent\Scope
{
    ...
    public function apply(Builder $builder, Model $model)
    {
        ...
        $builder->join('menu_translations','menus.id','=','menu_translations.menu_id')
            ...
            ->select('menus.id','menus.is_active','menus.is_approved',
                'menu_translations.name','menu_translations.short_description',
                'menu_translations.long_description','menu_translations.locale');
